...
export function Header() {
	...
	return (
		<header
			className={cn(
				'sticky top-0 z-50 mx-auto w-full max-w-[1200px] border-b border-transparent md:rounded-md md:border md:transition-all md:ease-out',
				{
					'bg-background/95 supports-[backdrop-filter]:bg-background/50 border-border backdrop-blur-lg md:top-4 md:max-w-[1280px] md:shadow':
						scrolled && !open,
		...
		>
			...
			>
				...
				<div className="hidden items-center gap-2 md:flex">
					...
					<Button variant="outline">聯絡德記</Button>
					<Button>限時優惠</Button>
				</div>
			...
			>
				...
				>
					...
					<div className="flex flex-col gap-2">
						...
						<Button className="w-full">限時優惠</Button>
					</div>
				</div>
			</div>
		</header>
